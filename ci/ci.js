...
function metAJour() {
  ...
  if (nPrep >= 1) {
    ...
    "<select id='groupesC1' onchange='calcule()'><option value=1>1 groupe</option><option value=2 selected>2 groupes</option><option value=3>3 groupes</option><option value=4>4 groupes</option></select> " +
    "<input id='etudiantsC1' type='number' value=55 onchange='calcule()'> élèves"
    ;
  }
  if (nPrep >= 2) {
    ...
    "<select id='groupesC2' onchange='calcule()'><option value=1 selected>1 groupe</option><option value=2>2 groupes</option><option value=3>3 groupes</option><option value=4>4 groupes</option></select> " +
    "<input id='etudiantsC2' type='number' value=21 onchange='calcule()'> élèves"
    ;
  }
  if (nPrep >= 3) {
    ...
    "<input id='etudiantsC3' type='number' value=30 onchange='calcule()'> élèves"
    ;
  }
  if (nPrep >= 4) {
    ...
    "<input id='etudiantsC4' type='number' value=30 onchange='calcule()'> élèves"
    ;
  }
  if (nPrep <= 3) {
    document.getElementById("montreCours4").innerHTML = ""
